	...
	<div class="logInPage">
		...
		<div class="loginFormContainer">
			...
			<div class="loginForm">
				...
				<label for="code" v-if="role == 'Teacher'">Code</label>
				<input
					type="text"
					name="code"
					id="code"
				...
				<div
					class="errorMessage"
					id="codeRequired"
					v-if="role == 'Teacher' && !hasCode && this.clicked"
				>
					Code is required
				</div>
			</div>
	...
	export default {
		data() {
			return {
				...
				code: "",
				clicked: false,
				data: { email: "user123@gmail.com", password: "Test123!" },
				signInDialog: false,
				error: false,
				errorMessage: "",
			};
		...
		methods: {
			...
			async logIn() {
				...
				if (this.role == "Student") {
					if (this.hasEmail && this.hasPassword && this.checkValidity) {
						if (
